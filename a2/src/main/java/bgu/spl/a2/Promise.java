...
public class Promise<T>{
	...
	public synchronized T get() {
		if (!isResolved())
			throw new IllegalStateException("unable to get unresolved value");
	...
	public synchronized void resolve(T value){
		if(isResolved()) throw new IllegalStateException("promise already resolved");
		else{
			isResolved=true;
			this.result=value;
			//make the callbacks
